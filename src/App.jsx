...
function Home() {
  return <main>
    ...
    <DevicesCarousel />
    <section className="numbers"><div><strong>7</strong><span>лет бережной<br />практики</span></div><div><strong>500<sup>+</sup></strong><span>счастливых<br />пациентов</span></div><div><strong>7</strong><span>экспертных<br />врачей</span></div></section>
